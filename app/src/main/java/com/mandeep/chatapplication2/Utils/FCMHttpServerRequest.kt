...
object FCMHttpServerRequest {
    ...
    fun sendNotification(receiverUserToken:String,username:String,message:String){
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            try {
                ...
                httpsURLConnection.setRequestProperty("Authorization", "key=${Constants.SERVER_KEY}")
